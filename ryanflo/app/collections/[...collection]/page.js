                ...
                {params.collection.length == 1 && (
                    <>
                        ...
                        {listProduct.current.length == 0 && (
                            <main className="col l-12 grid min-h-full place-items-center bg-white px-6 py-16 sm:py-16 lg:px-8">
                                ...
                                <div className="mt-10 flex items-center justify-center gap-x-6">
                                    ...
                                    <Link href="https://ryanflo.vercel.app/collections/all" className="text-sm font-semibold text-gray-900">
