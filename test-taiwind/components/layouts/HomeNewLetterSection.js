      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="w-full flex flex-col justify-between items-center lg:items-start gap-x-16 lg:flex-row">
          <div className="max-w-2xl text-center items-center flex flex-col justify-center">
            <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">Your review is our pleasure.</h2>
            <p className="mt-4 text-lg leading-8 text-gray-300">
              Don't hesitate to comment if you have any questions, interface errors or even something you don't like about our website.
            </p>
